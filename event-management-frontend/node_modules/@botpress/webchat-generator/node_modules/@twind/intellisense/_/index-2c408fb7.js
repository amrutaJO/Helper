...
function createIntellisense(config, options = {}) {
    ...
    return {
        ...
        async suggestAt (content, position, language) {
            ...
            let { extractBoundary  } = 'html' === language ? await import('./html-1cad48ff.js') : {
        ...
        async documentationAt (content, offset, language) {
            let result = null;
            if ('html' === language) {
                let { documentationAt  } = await import('./html-1cad48ff.js');
        ...
        async collectColors (content, language) {
            if ('html' === language) {
                let { collectColors  } = await import('./html-1cad48ff.js');
        ...
        async validate (content, language) {
            if ('html' === language) {
                let { validate  } = await import('./html-1cad48ff.js');
...
//# sourceMappingURL=index-2c408fb7.js.map
