...
function createIntellisense(config, options = {}) {
    ...
    return {
        ...
        async suggestAt (content, position, language) {
            ...
            let { extractBoundary  } = 'html' === language ? await import('./html-4dab8c3a.js') : {
        ...
        async documentationAt (content, offset, language) {
            let result = null;
            if ('html' === language) {
                let { documentationAt  } = await import('./html-4dab8c3a.js');
        ...
        async collectColors (content, language) {
            if ('html' === language) {
                let { collectColors  } = await import('./html-4dab8c3a.js');
        ...
        async validate (content, language) {
            if ('html' === language) {
                let { validate  } = await import('./html-4dab8c3a.js');
...
//# sourceMappingURL=index-21fade80.js.map
