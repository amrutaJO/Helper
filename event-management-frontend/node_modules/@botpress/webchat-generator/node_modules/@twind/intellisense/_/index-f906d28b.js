...
function createIntellisense(config, options = {}) {
    ...
    return {
        ...
        async suggestAt (content, position, language) {
            ...
            let { extractBoundary  } = 'html' === language ? await import('./html-cad1424a.js') : {
        ...
        async documentationAt (content, offset, language) {
            let result = null;
            if ('html' === language) {
                let { documentationAt  } = await import('./html-cad1424a.js');
        ...
        async collectColors (content, language) {
            if ('html' === language) {
                let { collectColors  } = await import('./html-cad1424a.js');
        ...
        async validate (content, language) {
            if ('html' === language) {
                let { validate  } = await import('./html-cad1424a.js');
...
//# sourceMappingURL=index-f906d28b.js.map
