...
function createIntellisense(config, options = {}) {
    ...
    function toSuggestion(suggestion) {
        return 'variant' === suggestion.type ? {
            ...
            name: suggestion.name,
            value: suggestion.value,
            description: suggestion.description ||= function(className) {
    ...
    return {
        ...
        async suggestAt (content, position, language) {
            ...
            let { extractBoundary  } = 'html' === language ? await import('./html-9ea8d9f3.js') : {
        ...
        async documentationFor (token, { format ='md'  } = {}) {
            ...
            mdnIndex = await (mdnIndexPromise ||= (async ()=>{
                try {
        ...
        async documentationAt (content, offset, language) {
            let result = null;
            if ('html' === language) {
                let { documentationAt  } = await import('./html-9ea8d9f3.js');
        ...
        async collectColors (content, language) {
            if ('html' === language) {
                let { collectColors  } = await import('./html-9ea8d9f3.js');
        ...
        async validate (content, language) {
            if ('html' === language) {
                let { validate  } = await import('./html-9ea8d9f3.js');
...
export { createIntellisense, editabelColorRe, parseColor };
//# sourceMappingURL=index-eab4ec48.js.map
