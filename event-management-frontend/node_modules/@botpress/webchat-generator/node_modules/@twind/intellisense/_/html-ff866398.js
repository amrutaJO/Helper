...
import { p as parseColor, e as editabelColorRe } from './index-def1498f.js';
...
function collectColors(content, { classes , isIgnored  }) {
    ...
    return parseHTML(content, (startIndex, endIndex, quote)=>{
        ...
        for (let rule of rules){
            ...
            if (null == completion ? void 0 : completion.color) {
...
//# sourceMappingURL=html-ff866398.js.map
